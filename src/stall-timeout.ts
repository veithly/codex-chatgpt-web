 ...
 *
 * Raised from 90s to 900s so long reasoning + large tool writes are not cut mid-turn.
 * Hung streams still die; they just get a more realistic window. A genuine adapter stall also
 * stops the turn-level heartbeats long before this budget on healthy pipelines.
 */
